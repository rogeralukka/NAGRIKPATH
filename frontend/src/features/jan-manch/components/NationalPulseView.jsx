...
/**
 * NationalPulseView:
 * Clean, authoritative Citizen Data Hub:
 * - 4 High-impact macro vital tiles
 * - 12-Card Responsive Recharts Grid with independent time scrubbers per card
 * - Clean citizen-facing typography without developer chrome
 */
export default function NationalPulseView() {
  ...
  const macroVitals = [
    ...
    },
    {
      ...
      unit: "/ USD",
      delta: "↘ 29.3%",
      deltaLabel: "6Y Rupee Depreciation",
      citation: "REF: RBI-WSS-SEP-2026",
      icon: DollarSign,
      isPositive: false, // Rupee weakening rendered in Rose/Red
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      {/* 2. Clean Citizen Header Row without developer chrome */}
